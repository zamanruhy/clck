...
export default function Switch(props) {
  ...
  return (
    ...
    >
      ...
      />
      <span
        class="relative h-5 w-10 shrink-0 rounded-full transition peer-focus-visible:(ring-3 ring-blue-500/50 ring-offset-2)"
        classList={{
        ...
        aria-hidden="true"
      >
        <span class="absolute top-1/2 left-1/2 -z-1 h-full min-h-9 w-full min-w-9 -translate-y-1/2 -translate-x-1/2 rounded-inherit" />
        <span
