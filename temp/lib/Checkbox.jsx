...
export default function Checkbox(props) {
  ...
  return (
    ...
    >
      ...
      />
      <span
        class="relative flex h-4.5 w-4.5 shrink-0 items-center justify-center rounded-sm border-(1 slate-300) peer-focus-visible:(ring-3 ring-blue-500/50 ring-offset-2)"
        classList={{
