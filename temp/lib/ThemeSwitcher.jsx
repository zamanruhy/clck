  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          class="absolute -top-1.5 -left-0.5 flex h-8 w-8 items-center justify-center rounded-inherit
          bg-slate-800 shadow transition [:focus-visible+*>&]:(ring-6px ring-slate-500/40)
            dark:(translate-x-5 bg-blue-800 [:focus-visible+*>&]:ring-slate-100/40)"
        >
          <svg
