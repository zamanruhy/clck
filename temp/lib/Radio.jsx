...
export default function Checkbox(props) {
  ...
  return (
    <label
      class="radio relative isolate flex w-fit cursor-pointer select-none items-center"
      classList={{
    ...
    >
      ...
      />
      <span
        class="relative flex h-5 w-5 shrink-0 items-center justify-center rounded-full
        border-(1 slate-300) peer-focus-visible:(ring-3 ring-blue-500/50 ring-offset-3)"
        classList={{
        ...
        aria-hidden="true"
      >
        <span class="absolute inset-t-1/2 top-1/2 left-1/2 -z-10 h-full min-h-9 w-full min-w-9 -translate-(y-1/2 x-1/2) rounded-inherit" />
        {localChecked() && (
